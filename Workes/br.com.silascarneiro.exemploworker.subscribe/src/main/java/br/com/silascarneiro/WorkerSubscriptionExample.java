...
public class WorkerSubscriptionExample implements BackgroundFunction<PubSubMessage> {

  private static final Logger logger = Logger.getLogger(WorkerSubscriptionExample.class.getName());
  private static final String PROJECT_ID = "aplicacao-gke";
  private static final String SUBSCRIPTION_ID = "br.com.silascarneiro.exemplo.worker-sub";
